    ...
    <>
      ...
      <main id="main">
        ...
        <section id="team" className="content-section team-section section-anchor"><div className="container">
          ...
          <div className="contact-line"><h3>Contact</h3>{program.contactEmail ? <a href={`mailto:${program.contactEmail}`}>{program.contactEmail}</a> : <p>For additional information please contact yunhui.guo@utdallas.edu.</p>}</div>
        </div></section>
