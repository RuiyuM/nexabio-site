    ...
    <>
      ...
      <main id="main">
        <section id="overview" className="hero section-anchor"><div className="container"><div className="hero-grid">
          <div><p className="eyebrow">{program.institution}</p><h1>{program.headline}</h1><p className="intro">{program.introduction}</p><a className="primary-link" href="#apply">View participation information <span aria-hidden="true">↗</span></a><div className="compensation-callout"><strong>{program.compensation.headline}</strong><p>{program.compensation.eligibility}</p></div></div>
