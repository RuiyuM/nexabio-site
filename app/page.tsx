  ...
  return (
    <>
      ...
      <div className="container footer-inner">
        ...
        <div><img className="nsf-footer-logo" src="/nexabio-site/images/NSF_logo.png" alt="NEXABio" width="1172" height="324" loading="lazy" /> <p>This program is currently funded by the National Science Foundation grants OAC 2612287.</p></div>
