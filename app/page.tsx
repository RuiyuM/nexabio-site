  ...
  return (
    <>
      ...
      <main id="main">
        ...
        <section id="program" className="content-section section-anchor"><div className="container">
          ...
          <div className="schedule"><h3>Proposed workshop timeline</h3>
            ...
            <p className="note">Each session will last approximately 45 minutes.</p>
        ...
        <section id="team" className="content-section team-section section-anchor"><div className="container">
          ...
          <div className="contact-line"><h3>Contact</h3>{program.contactEmail ? <a href={`mailto:${program.contactEmail}`}>{program.contactEmail}</a> : <p>For additional information please contact nexabioutd@gmail.com or yunhui.guo@utdallas.edu.</p>}</div>
        </div></section>
      ...
      <div className="container footer-inner">
        ...
        <div><img className="nsf-footer-logo" src="/nexabio-site/images/NSF_logo.png" alt="NSF" width="1172" height="324" loading="lazy" /> <p>This program is currently funded by the National Science Foundation grants OAC 2612287.</p></div>
