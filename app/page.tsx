...
export default function Home() {
  return (
    <>
      ...
      <div className="draft-bar"><div className="container"><strong>Draft</strong><span>Program details are subject to confirmation.</span></div></div>
      ...
      <main id="main">
        <section id="overview" className="hero section-anchor"><div className="container"><div className="hero-grid">
          <div><p className="eyebrow">{program.institution}</p><h1>{program.headline}</h1><div className="compensation-callout"><strong>{program.compensation.headline}</strong><p>{program.compensation.eligibility}</p></div><p className="intro">{program.introduction}</p><a className="primary-link" href="#apply">View participation information <span aria-hidden="true">↗</span></a></div>
